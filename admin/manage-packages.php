...
<html>
<head>
<title>SAT | admin manage packages</title>
...
{				?>		
						  <tr>
							...
							<td><a href="update-package.php?pid=<?php echo htmlentities($result->pid);?>"><button type="button" class="btn btn-primary btn-block">View Details</button></a></td>
						  </tr>
						 <?php $cnt=$cnt+1;} }?>
						</tbody>
					  </table>
