...
$sql="update TblTourPackages set PackageImage=:pimage where pid=:imgid";
...
<html>
<head>
<title>SAT | Admin Package Creation</title>
  ...
  <div class="grid-form1">
  	       <h3>Update Package Image </h3>
  	         ...
  	         <div class="tab-content">
						...
						<?php 
$imgid=intval($_GET['imgid']);
$sql = "SELECT PackageImage from TblTourPackages where pid=:imgid";
$query = $dbh -> prepare($sql);
$query -> bindParam(':imgid', $imgid, PDO::PARAM_STR);
$query->execute();
